...
namespace BossArena
{
    ...
    public class GameManager : Singleton<GameManager>
    {
        ...
        public async Task<LocalPlayer> Awaitm_localUserInitialization()
        {
        ...
        public void Setm_localUserName(string name)
        {
        ...
        public void Setm_localUserStatus(PlayerStatus status)
        {
        ...
        async void Sendm_localUserData()
        {
        ...
        //{
        //    m_m_localUser.UserStatus.Value = PlayerStatus.InGame;
        //    m_LocalLobby.LocalLobbyState.Value = LobbyState.InGame;
        //    m_setupInGame.StartNetworkedGame(m_LocalLobby, m_m_localUser);
        //}
...
#pragma warning restore 4014
        ...
        void SetLobbyView()
        {
            ...
            Setm_localUserStatus(PlayerStatus.Lobby);
