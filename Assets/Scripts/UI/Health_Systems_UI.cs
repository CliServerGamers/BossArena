...
{
    class Health_Systems_UI : MonoBehaviour
    {
        public static Health_Systems_UI Instance;
        ...
        void Start()
        {
            ...
            maxHitPoint = PlayerPrefab.GetComponent<Player>().MaxHealth.Value;
        }
        ...
        void Update()
        {
            if (Regenerate)
                Regen();
            hitPoint = PlayerPrefab.GetComponent<Player>().CurrentHealth.Value;
        }
